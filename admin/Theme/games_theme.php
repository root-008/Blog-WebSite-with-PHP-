<?php
    function func_games_article($baglan){
        echo '
            <article>
            <div class="container">
        ';
                ...
                <tr class="table-search">
                    <td colspan="8">
                        <form action="search_admin.php" method="POST" class="gameform">
                            ...
                            <button type="submit" name="game_ara"><i class="fa fa-search"></i></button>
                        </form>
                    </td>
                </tr>
        ';
        while ($satir = mysqli_fetch_assoc($sonuc)) {
            echo '
                <tr class="table-headers">
                    <td style="width:20px">Games_ID</td>
                ...
                <tr class = "table-content">
                    <td>' . $satir["Games_ID"] . '</td>
                    <td><img src="'.$satir["Games_img"].'" title="'.$satir["Games_img"].'" style="width:150px; height:100px"></td>
                    <td>' . $satir["Type"] . '</td>
                    <td>' . $satir["Title"] . '</td>
                    ...
                    <td>
                        <form action="edit.php" method="POST">
                            <button type="submit" name="data_update_games" value="'.$satir["Games_ID"].'" class="Btn"><i class="material-icons">sync</i><span>Düzenle</span></button>
                        </form>
                        <form action="delete.php" method="POST">
                            <button type="submit" name="data_delete_games" value="'.$satir["Games_ID"].'" class="Btn"><i class="material-icons">do_not_disturb</i><span>Sil</span></button>
                        </form>
                    </td>
                </tr>';
        }
